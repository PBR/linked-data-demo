...
var TEMPLATE_QUERIES = {
        1 : {
                ...
                // query : readFile('sparqlQueries_plant/template1.sparql', 'text'),
                queryGet : 'qID=1&pVar=#phenotypeVariable#&pVal=#phenotypeValue#'
            },
        2 : {
                text : 'Get accessions  with a specific phenotype',
                variables: ['phenotypeVariable', 'phenotypeValue'],
                // query : readFile('sparqlQueries_plant/template2.sparql', 'text'),
       ...
       3 : {
                ...
                variables: ['country'],
                // query : readFile('sparqlQueries_plant/template3.sparql', 'text'),
                queryGet : 'qID=3&country=#country#'
            },
       4 : {
                text : 'Get accessions from a specific country of origin',
                variables: ['country'],
                // query : readFile('sparqlQueries_plant/template4.sparql', 'text'),
       ...
       5 : {
                ...
                // query : readFile('sparqlQueries_plant/template5.sparql', 'text'),
       ...
       6 : {
                ...
                variables: ['phenotypeVariable', 'phenotypeValue', 'country'],
                // query : readFile('sparqlQueries_plant/template6.sparql', 'text'),
        ...
        7 : {
                ...
                // query : readFile('sparqlQueries_plant/template7.sparql', 'text'),
                queryGet : 'qID=7&bioStat=#biologicalStatus#'
            },
        8 : {
                text : 'Get accessions with a specific biological status',
                variables: ['biologicalStatus'],
                query : readFile('sparqlQueries_plant/template8.sparql', 'text'),
